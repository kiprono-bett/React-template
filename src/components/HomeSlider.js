          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-20">Money caught up in redundant IT hardware</div>
                <h1>servers, networking,equipment &amp; CPUs, storage drives </h1>
            ...
            <div className="col-lg-6">
              <div className="slider-images">
                <img
                  className="image"
                  src="assets/myimages/Screenshot 2024-10-04 092839.png"
                  alt="Slider"
                />
                <img
                  className="offer"
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="slider-images">
                <img
                  className="image"
                  src="assets/images/myimg/BRI_8367.jpg"
                  alt="Slider"
                />
                <img
                  className="offer"
            ...
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-20">  We offer best in market prices for your data centre</div>
                <h1> future of your IT infrastructure &amp; inovation</h1>
                <h6>25 Years of detailed bussiness
      ...
      >
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="slider-content">
                <div className="sub-title mb-20">Welcome to the cube</div>
                <h1>The cube  &amp; inovation</h1>
                <div className="slider-btns mt-30">
                  <Link href="/shop-grid">
                    <a className="theme-btn style-two">
                      Shop Now <i className="fas fa-angle-double-right" />
        ...
        <div className="container-fluid">
          <div className="row align-items-center">
            <div className="col-xl-5">
              <div className="slider-content">
                <div className="sub-title mb-20">Welcome to the cube </div>
                <h1>inovation  &amp;outside the box </h1>
                <p>Igniting innovation in the digital sphere
                  and fostering digital exellence together
